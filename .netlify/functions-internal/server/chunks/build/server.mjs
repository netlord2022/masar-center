import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getCurrentInstance, toRef, isRef, hasInjectionContext, inject, shallowRef, computed, ref, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { w as hasProtocol, x as isScriptProtocol, y as joinURL, z as withQuery, A as sanitizeStatusCode, B as getContext, C as parsePath, D as parseQuery, $ as $fetch$1, E as baseURL, F as createHooks, G as executeAsync, r as createError$1, H as toRouteMatcher, I as createRouter$1, J as defu, K as getRequestHeaders, L as getRequestURL, M as getCookie, N as getRequestHeader, t as destr, O as klona, P as createDefu, Q as parse$1, R as isEqual, S as withoutTrailingSlash, T as setCookie, U as deleteCookie, V as isEqual$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./about-DvySQdIr.mjs')
  },
  {
    name: "about___de",
    path: "/de/about",
  ...
  },
  {
    ...
    component: () => import('./index-C2OG3-4I.mjs')
  },
  {
    name: "index___de",
    path: "/de",
  ...
  en: [
    {
      ...
      load: () => import(
        './en-Bnjb3gXT.mjs'
        /* webpackChunkName: "locale_en_46json_ffd92885" */
      ),
      cache: true
    }
  ],
  de: [
    {
      ...
      load: () => import(
        './de-BfC0_blY.mjs'
        /* webpackChunkName: "locale_de_46json_1fd5056a" */
      ),
      cache: true
    }
  ],
  ar: [
    {
      ...
      load: () => import(
        './ar-Gdxb9ZTs.mjs'
        /* webpackChunkName: "locale_ar_46json_9b769928" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/d-xakhQz"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    let __temp, __restore;
    Object.defineProperty(_nuxt.versions, "nuxtI18n", { get: () => "10.2.0" });
    const nuxt = useNuxtApp(_nuxt._id);
    const runtimeI18n = useRuntimeI18n(nuxt);
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/d-xakhQz"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Dh3OQEWU.mjs').then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ class: "flex flex-col min-h-screen" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<main role="main"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_NuxtPage, { class: "grow" }, null, _parent2, _scopeId));
        _push2(`</main>`);
      } else {
        return [
          createVNode("main", { role: "main" }, [
            createVNode(_component_NuxtPage, { class: "grow" })
          ])
        ];
      }
    }),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D3JogcZn.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-8yDB9fTO.mjs'));
...
export { _export_sfc as _, useI18n as a, useState as b, useRoute as c, useLocaleHead as d, entry_default as default, useLocaleRoute as e, useRouter as f, useNuxtApp as g, useRuntimeConfig as h, isObject as i, nuxtLinkDefaults as j, useRequestEvent as k, navigateTo as n, resolveRouteObject as r, useHead as u };
